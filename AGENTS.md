# AGENTS.md — SafetyLM Project Memory

This file is auto-loaded at the start of every Codex session in this repo. It is the
...
├── AGENTS.md              # ← this file (project memory, auto-loaded)
...
- **Last completed:** Phase 0 admin setup — repo scaffolded, `git init`, this AGENTS.md authored
